...
function generatePlacesEditPlace(data)
{
    return(
        <GenerateSkeletonHtml information = {data.skeletonData} >
            <main>
                ...
                <div className="form-group">
                    ...
                    <input type="text" className="form-control" id="city" name="city" defaultValue={data.place.city} />
                </div>
                <div className="form-group">
...
module.exports = generatePlacesEditPlace;